...
export class AutoTrader {
    ...
    async trade() {
        ...
        if (okToTrade) {
            ...
            console.log(`Buy ${this.tradeInfo.coinQuantityAtBuy} ${token} on ${this.buyAccount.tradingPlatform.name}, price ${this.tradeInfo.buyPrice}`)
            console.log(`Sell ${this.tradeInfo.coinQuantityAtSell} ${token} on ${this.sellAccount.tradingPlatform.name}, price ${this.tradeInfo.sellPrice}`)
            console.log(`Actual profit: ${this.tradeInfo.baseCoinProfit} ${basedToken}`)
            await Promise.all([
